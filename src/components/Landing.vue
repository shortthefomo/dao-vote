        ...
        <div class="container-fluid py-5">
            ...
            <div class="col-md-12 fs-6">
                ...
                <p v-for="signer in signers">
                    <i :class="(signer.SignerEntry.Registered) ? 'bi bi-check-square-fill':'bi bi-dash-square-dotted'"></i> <i :class="`bi bi-${signer.SignerEntry.SignerWeight}-square${(signer.SignerEntry.Registered) ? '-fill':''}`"></i> Signer: {{ signer.SignerEntry.Account.substring(0, 8) }}...
                </p>
