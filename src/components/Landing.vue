<template>
    ...
    <div v-if="validatorData.latest_version === true && selectedVote.length > 0" class="text-center">
    ...
    <div v-if="validatorData.latest_version === false && selectedVote.length > 0" class="text-center">
