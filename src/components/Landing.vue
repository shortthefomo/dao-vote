...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            try {
                const { data } = await this.axios.get('https://vote-backend.panicbot.xyz/api/test', { timeout: 2000 })
        ...
        methods: {
            ...
            async fetchAccountInfo() {
                ...
                if ('MessageKey' in res.account_data) {
                    ...
                    const { data } = this.axios.get(`https://vote-backend.panicbot.xyz/api/v1/apps/encode-node-public?key=${res.account_data.MessageKey}`, { timeout: 3000 })
